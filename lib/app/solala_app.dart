...
import 'package:flutter_screenutil/flutter_screenutil.dart'; // أضف هذا الاستيراد
      ...
      builder: (context, child) {
        return MultiBlocProvider(
          providers: [
            ...
            BlocProvider<RcenetShopsCubit>(
              create: (_) => getIt<RcenetShopsCubit>()..getRcenetShops(),
            ),
