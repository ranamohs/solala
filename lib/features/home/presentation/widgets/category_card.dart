...
class CategoryCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final String title = ar ? categoryModel.name.ar : categoryModel.name.en;
      ...
      onTap: () => runIfConnected(
        ...
        onConnected: () {
          GoRouter.of(context).push(AppRouter.categoryDetailsView, extra: {
            ...
            'arName': categoryModel.name.ar,
            'enName': categoryModel.name.en,
          });
        },
      ),
      child: Container(
          ...
          child: Stack(
            children: [
              ...
              CachedNetworkImage(
                ...
                fit: BoxFit.cover,
                imageUrl: categoryModel.image ?? AppConstants.noImageUrl,
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // Chips row -> link-like + filled pill
                      Row(
                        children: [
                          // Details & Photos (link style with underline, orange)
                          _LinkChip(
                            label:
...
/// Orange underline "link" chip like the screenshot ("Details & Photos")
