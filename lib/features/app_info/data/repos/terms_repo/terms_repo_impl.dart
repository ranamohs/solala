...
import 'terms_repo.dart';

class TermsRepoImpl implements TermsRepo {
  final DioConsumer dioConsumer;
  TermsRepoImpl({required this.dioConsumer});

  @override
  Future<Either<String, AboutUsModel>> fetchTerms() async {
    try {
      final res = await dioConsumer.get(EndPoints.termsAndConditions);
